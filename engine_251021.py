...
#     print('anonymizer_img')
    ...
    return img_anon, metric


def anonymizer_img_list(img_array_list):
#     print('anonymizer_process')
    img_array_list_anon = []
    metrics = []
    for img in img_array_list:
        img_anon, metric = anonymizer_img(img)
...
def anonymizer(path):
    ...
    if type_file == '.pdf':
        ...
        img_array_list_anon, metrics = anonymizer_img_list(img_array_list)
